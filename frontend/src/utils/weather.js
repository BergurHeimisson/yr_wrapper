const SYMBOL_LABELS = {
  clearsky_day: 'Heiður himinn',
  clearsky_night: 'Stjörnubjart',
  fair_day: 'Létt skýjað',
  fair_night: 'Létt skýjað',
  partlycloudy_day: 'Skýjað',
  partlycloudy_night: 'Skýjað',
  cloudy: 'Skýjað',
  fog: 'Þoka',
  lightrain: 'Dropakast',
  rain: 'Rigning',
  heavyrain: 'Mellirigning',
  lightrainshowers_day: 'Skúrir með köflum',
  lightrainshowers_night: 'Skúrir með köflum',
  rainshowers_day: 'Skúrir',
  rainshowers_night: 'Skúrir',
  heavyrainshowers_day: 'Úrhelli',
  heavyrainshowers_night: 'Úrhelli',
  ...
  heavyrainandthunder: 'Úrhelli og þrumur',
  lightsleetandthunder: 'Slydda og þrumur',
  sleetandthunder: 'Slydda og þruma',
  lightsnowandthunder: 'Snjókoma og þrumur',
  snowandthunder: 'Snjókoma og þrumur',
}
